...
import { departureSvg, arrivalSvg } from '../../tickets/svg';
   ...
   return (
      <section className="details">
         ...
         <div className="sidebar_inner">
            <div className="sidebar_header title-goThere">
         ...
         <div className="details_footer">
            ...
            />
            <img className="details-сurrency-total" src={rub} alt="руб." />
         </div>
      </section>
   );
}
